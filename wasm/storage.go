...
//  sessionStorage.SetItem('myItem', 'itemValue')
//
func SessionStorage(action string, args ...interface{}) {
	js.Global().Get("sessionStorage").Call(action, args...)
}
...
//  localStorage.SetItem('myItem', 'itemValue')
//
func LocalStorage(action string, args ...interface{}) {
	js.Global().Get("localStorage").Call(action, args...)
}
